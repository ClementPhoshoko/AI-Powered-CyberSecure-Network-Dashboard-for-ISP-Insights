...
function Android() {
  ...
  const playStoreUrl = 'https://play.google.com/store/apps/details?id=com.akovolabs.speedtest';
  const features = [
  ...
  return (
    <div className="download_page">
      <Seo title={t('seo.downloadAndroidTitle')} description={t('seo.downloadAndroidDesc')} path="/download/android" />
      <div className="download_container">
        <section className="download_hero">
          ...
          <div className="download_content_section">
            <h1 className="download_headline">{t('download.android.title')}</h1>
            <p className="download_subtitle">{t('download.android.subtitle')}</p>
            ...
            <p className="download_advisory">{t('download.android.advisory')}</p>
          </div>
        </section>
      </div>
    </div>
